...
- [x] **Windows CI**: `pnpm exec vitest run tests/init-retire-claude.test.ts --no-file-parallelism` — PowerShell rejection and update-preservation scenarios execute on `windows-latest` (runs `30504923196` and `30505439604`)
- [x] **Rule Compliance**:
