...
interface OutputState {
  readonly action: {
    ...
    readonly cliEquivalent?: unknown;
  };
  readonly result: {
    readonly ok: boolean;
...
export function sanitizeTerminalOutput(text: unknown): string {
...
export function getOutputLines(
  ...
  { maxOutputLines = DEFAULT_MAX_OUTPUT_LINES, maxOutputBytes = DEFAULT_MAX_OUTPUT_BYTES }: OutputOptions = {},
): string[] {
