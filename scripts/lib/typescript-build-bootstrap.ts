...
const windowsCompilerCommand = "pnpm.cmd exec tsc -p \"%AFERGON_AI_TSCONFIG%\" --outDir \"%AFERGON_AI_TSCONFIG_OUTDIR%\" --tsBuildInfoFile \"%AFERGON_AI_TSBUILDINFO%\"";
  ...
  if (platform === "win32") {
    ...
    return {
      ...
      options: {
        ...
        env: {
          ...process.env,
          AFERGON_AI_TSCONFIG: "tsconfig.build.json",
